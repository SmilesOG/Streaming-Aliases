...
logger = logging.getLogger("usanetwork_" + str(current_timestamp))
logger.setLevel(logging.DEBUG)
# create file handler which logs even debug messages
temp_dir = tempfile.gettempdir()
fh = logging.FileHandler(temp_dir + "\Streams\\" + "usanetwork.log", mode="w")
...
driver.get("https://thetvapp.to/tv/usa-network-live-stream/")
