...
logger = logging.getLogger("natgeo_" + str(current_timestamp))
logger.setLevel(logging.DEBUG)
# create file handler which logs even debug messages
temp_dir = tempfile.gettempdir()
fh = logging.FileHandler(temp_dir + "\Streams\\" + "natgeo.log", mode="w")
...
driver.get("https://thetvapp.to/tv/national-geographic-live-stream/")
